...
function calculateSatFats(e) {
  ...
  document.querySelector(
    "#totalAmountOfSatFats"
  ).textContent = `If you need about ${calories} calories a day, the recommended amount of saturated fat for you is ${grPer5caloriesFromSatFats.toFixed()} to ${grPer6caloriesFromSatFats.toFixed()} grams per day.`;
}
